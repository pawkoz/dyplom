...
DefNode( CompositorNode, CMP_NODE_CHANNEL_MATTE,  def_cmp_channel_matte,  "CHANNEL_MATTE",  ChannelMatte,     "Pawel Key",       ""              )
...
DefNode( CompositorNode, CMP_NODE_PAWEL_MATTE,	  def_cmp_pawel_matte,	  "PAWEL_MATTE",    PawelMatte,       "Pawel Key",         ""				)
